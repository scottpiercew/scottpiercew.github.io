...
import { FaTwitterSquare, FaLinkedinSquare, FaGithubSquare } from 'react-icons/lib/fa';
        ...
        <Headroom calcHeightOnResize disableInlineStyles>
          <Fade down duration={2000} className={styles.wrapper}>
            ...
            <div className={styles.socialMedia}>
              <span>
                <a href="https://twitter.com/scottpiercew" target="_blank" rel="noopener noreferrer">
                  <FaTwitterSquare />
                </a>
                <a href="https://www.linkedin.com/in/scott-pierce-wrobel/" target="_blank" rel="noopener noreferrer">
                  <FaLinkedinSquare />
                </a>
                <a href="https://github.com/scottpiercew" target="_blank" rel="noopener noreferrer">
                  <FaGithubSquare />
                </a>
              </span>
            </div>
